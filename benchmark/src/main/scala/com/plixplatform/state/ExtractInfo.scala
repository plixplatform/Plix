...
import com.plixlatform.lang.v1.traits.DataType
...
import com.plixlatform.transaction.{Authorized, CreateAliasTransactionV1, DataTransaction, Transaction}
...
object ExtractInfo extends App with ScorexLogging {
  ...
  try {
    val state = new LevelDBWriter(
      ...
      plixSettings.blockchainSettings.functionalitySettings,
      plixSettings.dbSettings
    )
