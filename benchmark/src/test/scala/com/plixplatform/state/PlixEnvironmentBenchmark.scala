...
import com.plixlatform.account.{AddressOrAlias, AddressScheme, Alias}
...
import com.plixlatform.db.LevelDBFactory
import com.plixlatform.lang.v1.traits.Environment
import com.plixlatform.lang.v1.traits.domain.Recipient
import com.plixlatform.settings.{PlixSettings, loadConfig}
import com.plixlatform.state.PlixEnvironmentBenchmark._
import com.plixlatform.state.bench.DataTestData
...
/**
  ...
  * 2. Import it: https://github.com/plixlatform/Plix/wiki/Export-and-import-of-the-blockchain#import-blocks-from-the-binary-file
...
class PlixEnvironmentBenchmark {
  ...
  @Benchmark
  def accountBalanceOf_plix_test(st: AccountBalanceOfPlixSt, bh: Blackhole): Unit = {
...
object PlixEnvironmentBenchmark {
  ...
  @State(Scope.Benchmark)
  class AccountBalanceOfPlixSt extends BaseSt {
  ...
  @State(Scope.Benchmark)
  class AccountBalanceOfAssetSt extends AccountBalanceOfPlixSt {
  ...
  class BaseSt {
    ...
    val environment: Environment = {
      ...
      val state            = new LevelDBWriter(db, portfolioChanges, plixSettings.blockchainSettings.functionalitySettings, plixSettings.dbSettings)
      new PlixEnvironment(
