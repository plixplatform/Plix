...
import com.plixlatform.settings.{DBSettings, FunctionalitySettings}
...
trait BaseState {
  ...
  private val initGen: Gen[(KeyPair, Block)] = for {
    ...
    val genesisTx = GenesisTransaction.create(rich, plix(100000000L), System.currentTimeMillis() - 10000).explicitGet()
