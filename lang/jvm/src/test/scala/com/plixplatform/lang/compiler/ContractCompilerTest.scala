package com.plixplatform.lang.compiler

import cats.kernel.Monoid
import com.plixplatform.common.state.ByteStr
import com.plixplatform.common.utils.EitherExt2
import com.plixplatform.lang.Common
import com.plixplatform.lang.Common.{NoShrink, produce}
...
import com.plixplatform.lang.v1.compiler.{CompilerContext, Terms}
import com.plixplatform.lang.v1.evaluator.FunctionIds
...
import com.plixplatform.lang.v1.testing.ScriptGen
import com.plixplatform.lang.v1.{ContractLimits, compiler}
...
class ContractCompilerTest extends PropSpec with PropertyChecks with Matchers with ScriptGen with NoShrink {
  ...
  property("hodlContract") {
    val ctx = Monoid
      .combineAll(
        Seq(
          PureContext.build(com.plixplatform.lang.Global, V3),
          CryptoContext.build(com.plixplatform.lang.Global, V3),
          PlixContext.build(
            DirectiveSet(V3, Account, DAppType).explicitGet(),
            Common.emptyBlockchainEnvironment()
          )
    ...
    val expr = {
      val script =
        """
          ...
          |   else TransferSet([ScriptTransfer(i.caller, plixBalance(this), base58'somestr')])
          | }
          |
          | @Verifier(t)
          | func verify() = {
  ...
  property("matching case with non-existing type should produce error message with suitable types") {
    ...
    val verifierTypes = PlixContext.verifierInput.typeList.map(_.name)
