package com.plixlatform.lang.compiler

import cats.kernel.Monoid
import com.plixlatform.common.state.ByteStr
import com.plixlatform.common.utils.EitherExt2
import com.plixlatform.lang.Common
import com.plixlatform.lang.Common.{NoShrink, produce}
...
import com.plixlatform.lang.v1.compiler.{CompilerContext, Terms}
import com.plixlatform.lang.v1.evaluator.FunctionIds
...
import com.plixlatform.lang.v1.{ContractLimits, compiler}
...
class ContractCompilerTest extends PropSpec with PropertyChecks with Matchers with ScriptGen with NoShrink {
  ...
  property("hodlContract") {
    val ctx = Monoid
      .combineAll(
        Seq(
          PureContext.build(com.plixlatform.lang.Global, V3),
          CryptoContext.build(com.plixlatform.lang.Global, V3),
          PlixContext.build(
            DirectiveSet(V3, Account, DAppType).explicitGet(),
            Common.emptyBlockchainEnvironment()
          )
