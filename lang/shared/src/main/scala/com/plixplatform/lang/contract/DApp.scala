package com.plixplatform.lang.contract

import com.plixplatform.common.state.ByteStr
import com.plixplatform.lang.contract.DApp.{CallableFunction, VerifierFunction}
import com.plixplatform.lang.v1.compiler.CompilationError.Generic
import com.plixplatform.lang.v1.compiler.Terms.DECLARATION
import com.plixplatform.lang.v1.compiler.Types._
import com.plixplatform.lang.v1.compiler.{CompilationError, Terms}
...
object DApp {
  ...
  case class CallableAnnotation(invocationArgName: String) extends Annotation {
    lazy val dic: Map[String, CASETYPEREF] = Map(invocationArgName -> com.plixplatform.lang.v1.evaluator.ctx.impl.plix.Types.invocationType)
  }
