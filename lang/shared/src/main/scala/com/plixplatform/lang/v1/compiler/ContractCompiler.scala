package com.plixplatform.lang.v1.compiler
import cats.Show
import cats.implicits._
import com.plixplatform.common.state.ByteStr
import com.plixplatform.lang.contract.DApp
import com.plixplatform.lang.contract.DApp._
import com.plixplatform.lang.v1.compiler.CompilationError.{AlreadyDefined, Generic, WrongArgumentType}
import com.plixplatform.lang.v1.compiler.CompilerContext.vars
import com.plixplatform.lang.v1.compiler.ExpressionCompiler._
import com.plixplatform.lang.v1.compiler.Terms.DECLARATION
import com.plixplatform.lang.v1.compiler.Types.{BOOLEAN, UNION}
import com.plixplatform.lang.v1.evaluator.ctx.FunctionTypeSignature
import com.plixplatform.lang.v1.evaluator.ctx.impl.plix.{FieldNames, PlixContext}
import com.plixplatform.lang.v1.parser.Expressions.{FUNC, PART, Pos}
import com.plixplatform.lang.v1.parser.{Expressions, Parser}
import com.plixplatform.lang.v1.task.imports._
      ...
      case (List(c: CallableAnnotation), (func, tpe, _)) =>
        for {
          _ <- Either
            .cond(
              tpe match {
                case _ if tpe <= UNION(PlixContext.writeSetType, PlixContext.scriptTransferSetType, PlixContext.scriptResultType) =>
                  true
                case _ => false
              },
              (),
