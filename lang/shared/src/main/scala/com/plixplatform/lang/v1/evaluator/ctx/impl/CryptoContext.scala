package com.plixlatform.lang.v1.evaluator.ctx.impl

import cats.Eval
import cats.data.EitherT
import cats.syntax.either._
import com.plixlatform.common.state.ByteStr
import com.plixlatform.lang.directives.values.{StdLibVersion, V3, _}
import com.plixlatform.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_BYTESTR, CONST_STRING, CaseObj}
import com.plixlatform.lang.v1.compiler.Types.{BOOLEAN, BYTESTR, CASETYPEREF, FINAL, STRING, UNION}
import com.plixlatform.lang.v1.compiler.{CompilerContext, Terms}
import com.plixlatform.lang.v1.evaluator.FunctionIds._
import com.plixlatform.lang.v1.evaluator.ctx.impl.crypto.RSA.DigestAlgorithm
import com.plixlatform.lang.v1.evaluator.ctx.{BaseFunction, EvaluationContext, LazyVal, NativeFunction}
import com.plixlatform.lang.v1.{BaseGlobal, CTX}
...
object CryptoContext {
  ...
  private def algFromCO(obj: Terms.CaseObj): Either[String, DigestAlgorithm] = {
    import com.plixlatform.lang.v1.evaluator.ctx.impl.crypto.RSA._
    obj match {
