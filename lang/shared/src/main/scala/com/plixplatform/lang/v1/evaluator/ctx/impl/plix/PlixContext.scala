package com.plixlatform.lang.v1.evaluator.ctx.impl.plix
...
import com.plixlatform.lang.v1.compiler.Types.{BYTESTR, LONG, STRING, _}
import com.plixlatform.lang.v1.evaluator.FunctionIds._
import com.plixlatform.lang.v1.evaluator.ctx._
import com.plixlatform.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext, _}
import com.plixlatform.lang.v1.traits._
import com.plixlatform.lang.v1.traits.domain.{OrdType, Recipient}
import com.plixlatform.lang.v1.{CTX, FunctionHeader}

object PlixContext {

  import Bindings._
  import Types._
  import com.plixlatform.lang.v1.evaluator.ctx.impl.converters._
  ...
  def build(ds: DirectiveSet, env: Environment): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.plixlatform.lang.v1.compiler.Types.UNION.create(UNIT +: anyTransactionType.typeList)
    ...
    val assetBalanceF: BaseFunction =
      NativeFunction(
        ...
        ("addressOrAlias", addressOrAliasType, "account"),
        ("assetId", UNION(UNIT, BYTESTR), "assetId (PLIX if none)")
      ) {
    ...
    val plixBalanceF: UserFunction =
      UserFunction("plixBalance", 109, LONG, "get PLIX balance for account", ("@addressOrAlias", addressOrAliasType, "account")) {
    ...
    val commonVars = Map(
      ("height", ((com.plixlatform.lang.v1.compiler.Types.LONG, "Current blockchain height"), LazyVal(EitherT(heightCoeval)))),
    )
    ...
    val types = buildPlixTypes(proofsEnabled, version)
