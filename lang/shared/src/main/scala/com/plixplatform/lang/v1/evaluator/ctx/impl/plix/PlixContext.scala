package com.plixplatform.lang.v1.evaluator.ctx.impl.plix
...
import com.plixplatform.lang.v1.compiler.Types.{BYTESTR, LONG, STRING, _}
import com.plixplatform.lang.v1.evaluator.FunctionIds._
import com.plixplatform.lang.v1.evaluator.ctx._
import com.plixplatform.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext, _}
import com.plixplatform.lang.v1.traits._
import com.plixplatform.lang.v1.traits.domain.{OrdType, Recipient}
import com.plixplatform.lang.v1.{CTX, FunctionHeader}

object PlixContext {

  import Bindings._
  import Types._
  import com.plixplatform.lang.v1.evaluator.ctx.impl.converters._
  ...
  def build(ds: DirectiveSet, env: Environment): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.plixplatform.lang.v1.compiler.Types.UNION.create(UNIT +: anyTransactionType.typeList)
    ...
    val commonVars = Map(
      ("height", ((com.plixplatform.lang.v1.compiler.Types.LONG, "Current blockchain height"), LazyVal(EitherT(heightCoeval)))),
    )
