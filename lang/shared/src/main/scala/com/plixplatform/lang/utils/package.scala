...
import com.plixlatform.lang.v1.compiler.{CompilerContext, DecompilerContext}
...
import com.plixlatform.lang.v1.{BaseGlobal, CTX, FunctionHeader}
        ...
        val ctx = Coeval.evalOnce(
          Monoid.combineAll(
            Seq(
              ...
              PlixContext.build(ds, environment)
            )
          )
        )
        ds -> ctx
