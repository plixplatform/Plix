package com.plixplatform.lang.v1

import com.plixplatform.lang.v1.evaluator.ctx.impl.crypto.RSA.DigestAlgorithm
import com.plixplatform.lang.ValidationError.ScriptParseError
import com.plixplatform.lang.contract.{ContractSerDe, DApp}
import com.plixplatform.lang.directives.values.{Expression, StdLibVersion, DApp => DAppType}
import com.plixplatform.lang.script.{ContractScript, Script}
import com.plixplatform.lang.utils
import com.plixplatform.lang.v1.compiler.Terms.EXPR
import com.plixplatform.lang.v1.compiler.{CompilerContext, ContractCompiler, ExpressionCompiler, Terms}
...
trait BaseGlobal {
  ...
  def compileExpression(input: String,
    ...
    for {
      ...
      illegalBlockVersionUsage = restrictToLetBlockOnly && com.plixplatform.lang.v1.compiler.сontainsBlockV2(ex)
