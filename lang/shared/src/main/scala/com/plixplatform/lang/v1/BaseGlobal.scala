package com.plixlatform.lang.v1
...
import com.plixlatform.lang.contract.{ContractSerDe, DApp}
import com.plixlatform.lang.directives.values.{Expression, StdLibVersion, DApp => DAppType}
import com.plixlatform.lang.script.{ContractScript, Script}
import com.plixlatform.lang.utils
import com.plixlatform.lang.v1.compiler.Terms.EXPR
import com.plixlatform.lang.v1.compiler.{CompilerContext, ContractCompiler, ExpressionCompiler, Terms}
...
trait BaseGlobal {
  ...
  def compileExpression(input: String,
    ...
    for {
      ...
      illegalBlockVersionUsage = restrictToLetBlockOnly && com.plixlatform.lang.v1.compiler.сontainsBlockV2(ex)
