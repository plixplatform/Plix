package com.plixplatform.lang.script.v1
...
import com.plixplatform.lang.v1.ContractLimits._
import com.plixplatform.lang.v1.compiler.Terms._
import com.plixplatform.lang.v1.{BaseGlobal, ScriptEstimator}
...
object ExprScript {
  ...
  private case class ExprScriptImpl(stdLibVersion: StdLibVersion, expr: EXPR, complexity: Long) extends ExprScript {
    ...
    override val containsBlockV2: Coeval[Boolean] = Coeval.evalOnce(com.plixplatform.lang.v1.compiler.сontainsBlockV2(expr))
  }
