...
import com.plixplatform.lang.Version
...
import com.plixplatform.lang.directives.Directive.extractDirectives
import com.plixplatform.lang.directives.values.{DApp => DAppType, _}
import com.plixplatform.lang.directives.{DirectiveDictionary, DirectiveParser, DirectiveSet}
import com.plixplatform.lang.v1.FunctionHeader.{Native, User}
import com.plixplatform.lang.v1.compiler.Terms._
import com.plixplatform.lang.v1.compiler.Types._
...
import com.plixplatform.lang.v1.traits.domain.{BlockInfo, Recipient, ScriptAssetInfo, Tx}
import com.plixplatform.lang.v1.traits.{DataType, Environment}
import com.plixplatform.lang.v1.{CTX, ContractLimits}
...
object JsAPI {
  ...
  private def plixContext(v: StdLibVersion, isTokenContext: Boolean, isContract: Boolean) =
    PlixContext.build(
  ...
  private def buildScriptContext(v: StdLibVersion, isTokenContext: Boolean, isContract: Boolean): CTX = {
    Monoid.combineAll(Seq(pureContext(v), cryptoContext(v), plixContext(v, isTokenContext, isContract)))
  }

  private def buildContractContext(v: StdLibVersion): CTX = {
    Monoid.combineAll(Seq(pureContext(v), cryptoContext(v), plixContext(v, isTokenContext = false, isContract = true)))
  }
