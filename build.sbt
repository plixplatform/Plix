...
lazy val versionSourceTask = (path: String) =>
  Def.task {
    ...
    val FallbackVersion = (1, 1, 3)

    val versionFile      = sourceManaged.value / "com" / "plixplatform" / "Version.scala"
...
lazy val langJS  = lang.js.settings(versionSourceSetting("com.plixplatform.lang"))
...
lazy val node = project
  ...
  .settings(versionSourceSetting("com.plixplatform"))
...
inScope(Global)(
  Seq(
    scalaVersion := "2.12.8",
    organization := "com.plixplatform",
    organizationName := "Plix Platform",
    organizationHomepage := Some(url("https://plixcoin.io")),
    scmInfo := Some(ScmInfo(url("https://github.com/plixplatform/Plix"), "git@github.com:plixplatform/Plix.git", None)),
    licenses := Seq(("MIT", url("https://github.com/plixplatform/Plix/blob/master/LICENSE"))),
    scalacOptions ++= Seq(
      "-feature",
      "-deprecation",
      "-unchecked",
