...
lazy val versionSourceTask = (path: String) =>
  Def.task {
    ...
    val versionFile      = sourceManaged.value / "com" / "plixlatform" / "Version.scala"
...
lazy val langJS  = lang.js.settings(versionSourceSetting("com.plixlatform.lang"))
...
lazy val node = project
  ...
  .settings(versionSourceSetting("com.plixlatform"))
...
inScope(Global)(
  Seq(
    scalaVersion := "2.12.8",
    organization := "com.plixlatform",
    organizationName := "Plix Platform",
    organizationHomepage := Some(url("https://plixlatform.com")),
    scmInfo := Some(ScmInfo(url("https://github.com/plixlatform/Plix"), "git@github.com:plixlatform/Plix.git", None)),
    licenses := Seq(("MIT", url("https://github.com/plixlatform/Plix/blob/master/LICENSE"))),
    scalacOptions ++= Seq(
      "-feature",
      "-deprecation",
      "-unchecked",
