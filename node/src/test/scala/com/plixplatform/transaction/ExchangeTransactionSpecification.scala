...
import com.plixlatform.transaction.TxValidationError.OrderValidationError
...
import com.plixlatform.{NTPTime, TransactionGen}
...
class ExchangeTransactionSpecification extends PropSpec with PropertyChecks with Matchers with TransactionGen with NTPTime {
  ...
  property("ExchangeTransaction balance changes") {
    ...
    forAll(preconditions) {
      case (sender1, sender2, matcher, pair, buyerMatcherFeeAssetId, sellerMatcherFeeAssetId, versions) =>
        ...
        create(
          buyOrder = buy.updatePair(buy.assetPair.copy(amountAsset = Plix)),
  ...
  property("JSON format validation") {
    val js = Json.parse("""{
         ...
         "sender":"3JPz3LVFHVWC8M7GShVJ8ciBc72NSjNN12B",
         ...
         "order1":{
            ...
            "sender":"3JGfKqSxbtuUh2fMjJqTBJSeaJUD2Q4JVU5",
         ...
         "order2":{
            ...
            "sender":"3JFuJU1nava3DM7gHhRp13K97TzgWEvVGE4",
