...
class SetScriptTransactionSpecification extends GenericTransactionSpecification[SetScriptTransaction] {
  ...
  def transactionParser: com.plixlatform.transaction.TransactionParserFor[SetScriptTransaction] = SetScriptTransaction
  ...
  def generator: Gen[((Seq[com.plixlatform.transaction.Transaction], SetScriptTransaction))] = setScriptTransactionGen.map(t => (Seq(), t))
