...
import com.plixlatform.{TransactionGen, Version}
...
class ClientSpec extends FreeSpec with Matchers with MockFactory with TransactionGen {
  ...
  "should match application name" in {
    HandshakeHandler.checkApplicationName("plixA", "plixA") shouldBe true
    HandshakeHandler.checkApplicationName("wavesA", "plixA") shouldBe true

    HandshakeHandler.checkApplicationName("wavesA", "plixK") shouldBe false
