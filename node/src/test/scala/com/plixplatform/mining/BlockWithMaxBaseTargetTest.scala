...
import com.plixlatform.mining.BlockWithMaxBaseTargetTest.Env
import com.plixlatform.settings.{PlixSettings, _}
import com.plixlatform.state._
import com.plixlatform.state.appender.BlockAppender
import com.plixlatform.state.diffs.ENOUGH_AMT
import com.plixlatform.transaction.{BlockchainUpdater, GenesisTransaction}
import com.plixlatform.utils.BaseTargetReachedMaximum
...
object BlockWithMaxBaseTargetTest {
  ...
  final case class Env(settings: PlixSettings,
                       pos: PoSSelector,
