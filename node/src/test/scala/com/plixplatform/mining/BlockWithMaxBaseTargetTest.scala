...
import com.plixplatform.mining.BlockWithMaxBaseTargetTest.Env
import com.plixplatform.settings.{PlixSettings, _}
import com.plixplatform.state._
import com.plixplatform.state.appender.BlockAppender
import com.plixplatform.state.diffs.ENOUGH_AMT
import com.plixplatform.transaction.{BlockchainUpdater, GenesisTransaction}
import com.plixplatform.utils.BaseTargetReachedMaximum
