...
import com.plixplatform.db.{WithDomain, openDB}
import com.plixplatform.features.BlockchainFeatures
import com.plixplatform.history.{StorageFactory, randomSig}
...
import com.plixplatform.lang.v1.compiler.{CompilerContext, ExpressionCompiler}
import com.plixplatform.mining._
...
import com.plixplatform.transaction.TxValidationError.SenderIsBlacklisted
...
import com.plixplatform.transaction.{Asset, Transaction, _}
...
class UtxPoolSpecification
  ...
  "UTX Pool" - {
    ...
    "correctly process constrainst in packUnconfirmed" in {
      withDomain(plixplatform.history.TransfersV2ActivatedAt0PlixSettings) { d =>
