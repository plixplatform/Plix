...
package object history {
  ...
  val MicroblocksActivatedAt0PlixSettings: PlixSettings = settings.copy(blockchainSettings = MicroblocksActivatedAt0BlockchainSettings)

  val DataAndMicroblocksActivatedAt0PlixSettings: PlixSettings =
    settings.copy(blockchainSettings = DataAndMicroblocksActivatedAt0BlockchainSettings)

  val TransfersV2ActivatedAt0PlixSettings: PlixSettings = settings.copy(blockchainSettings = TransfersV2ActivatedAt0BlockchainSettings)

  val DefaultPlixSettings: PlixSettings = settings.copy(blockchainSettings = DefaultBlockchainSettings,
