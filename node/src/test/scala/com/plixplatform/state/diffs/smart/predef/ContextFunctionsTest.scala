...
import com.plixplatform.lagonaki.mocks.TestBlock._
...
import com.plixplatform.lang.v1.compiler.{ExpressionCompiler, Terms}
...
import com.plixplatform.state.diffs.{ENOUGH_AMT, FeeValidation, assertDiffAndState}
  ...
  val preconditionsAndPayments
    ...
    untypedScript <- Gen
      ...
      .map {
        ...
        case 2 => scriptWithV1PlixFunctions(dataTransaction, transfer)
