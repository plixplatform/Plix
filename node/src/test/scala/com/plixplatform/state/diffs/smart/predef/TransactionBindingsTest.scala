package com.plixplatform.state.diffs.smart.predef

import com.plixplatform.account.{Address, Alias}
import com.plixplatform.common.state.ByteStr
import com.plixplatform.common.utils.EitherExt2
import com.plixplatform.common.state.diffs.ProduceError._
import com.plixplatform.lang.Testing.evaluated
import com.plixplatform.lang.directives.values._
import com.plixplatform.lang.directives.DirectiveSet
import com.plixplatform.lang.v1.compiler
import com.plixplatform.lang.v1.compiler.ExpressionCompiler
import com.plixplatform.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_BYTESTR, CONST_LONG, CONST_STRING, EVALUATED}
...
import com.plixplatform.transaction.smart.BlockchainContext.In
import com.plixplatform.transaction.smart.PlixEnvironment
import com.plixplatform.transaction.{Proofs, ProvenTransaction, VersionedTransaction}
...
class TransactionBindingsTest extends PropSpec with PropertyChecks with Matchers with TransactionGen with NoShrink {
  ...
  def runForAsset(script: String): Either[String, EVALUATED] = {
    ...
    import com.plixplatform.lang.v1.CTX._
