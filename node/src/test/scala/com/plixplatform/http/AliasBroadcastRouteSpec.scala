...
import com.plixplatform.api.http.alias.AliasBroadcastApiRoute
...
class AliasBroadcastRouteSpec
  ...
  "returns appropriate error code when validation fails for" - {
    ...
    "create alias transaction" in forAll(createAliasReq) { req =>
      import com.plixplatform.api.http.alias.SignedCreateAliasV1Request.broadcastAliasV1RequestReadsFormat
