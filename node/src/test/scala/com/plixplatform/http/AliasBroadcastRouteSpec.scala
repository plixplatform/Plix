...
import com.plixlatform.api.http.alias.AliasBroadcastApiRoute
...
class AliasBroadcastRouteSpec
  ...
  "returns appropriate error code when validation fails for" - {
    ...
    "create alias transaction" in forAll(createAliasReq) { req =>
      import com.plixlatform.api.http.alias.SignedCreateAliasV1Request.broadcastAliasV1RequestReadsFormat
