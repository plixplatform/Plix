...
import com.plixplatform.account.{Address, AddressOrAlias}
import com.plixplatform.api.http.AddressApiRoute
import com.plixplatform.api.http.ApiError.ApiKeyNotValid
import com.plixplatform.common.state.ByteStr
import com.plixplatform.common.utils.{Base58, Base64, EitherExt2}
import com.plixplatform.http.ApiMarshallers._
import com.plixplatform.lang.directives.values.V3
import com.plixplatform.lang.script.ContractScript
import com.plixplatform.state.StringDataEntry
import monix.execution.Scheduler

import scala.util.Random
// [WAIT] import com.plixplatform.lang.{Global, StdLibVersion}
import com.plixplatform.lang.contract.DApp
import com.plixplatform.lang.contract.DApp.{VerifierAnnotation, VerifierFunction}
// [WAIT] import com.plixplatform.lang.v1.compiler.Decompiler
import com.plixplatform.lang.v1.compiler.Terms._
// [WAIT] import com.plixplatform.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
...
import com.plixplatform.{NoShrink, TestTime, TestWallet, crypto}
...
class AddressRouteSpec
  ...
  routePath(s"/scriptInfo/${allAddresses(1)}") in {
    ...
    Get(routePath(s"/scriptInfo/${allAddresses(3)}")) ~> route ~> check {
      ...
      // [WAIT]                                           Decompiler(
      //      testContract,
      //      Monoid.combineAll(Seq(PureContext.build(com.plixplatform.lang.directives.values.StdLibVersion.V3), CryptoContext.build(Global))).decompilerContext)
