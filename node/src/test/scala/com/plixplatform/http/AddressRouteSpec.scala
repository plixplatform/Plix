...
import com.plixlatform.account.{Address, AddressOrAlias}
...
// [WAIT] import com.plixlatform.lang.{Global, StdLibVersion}
import com.plixlatform.lang.contract.DApp
import com.plixlatform.lang.contract.DApp.{VerifierAnnotation, VerifierFunction}
// [WAIT] import com.plixlatform.lang.v1.compiler.Decompiler
import com.plixlatform.lang.v1.compiler.Terms._
// [WAIT] import com.plixlatform.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
...
import com.plixlatform.{NoShrink, TestTime, TestWallet, crypto}
...
class AddressRouteSpec
  ...
  routePath(s"/scriptInfo/${allAddresses(1)}") in {
    ...
    Get(routePath(s"/scriptInfo/${allAddresses(3)}")) ~> route ~> check {
      ...
      // [WAIT]                                           Decompiler(
      //      testContract,
      //      Monoid.combineAll(Seq(PureContext.build(com.plixlatform.lang.directives.values.StdLibVersion.V3), CryptoContext.build(Global))).decompilerContext)
