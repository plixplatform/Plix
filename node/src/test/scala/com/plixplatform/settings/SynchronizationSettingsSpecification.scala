...
import com.plixlatform.network.InvalidBlockStorageImpl.InvalidBlockStorageSettings
import com.plixlatform.settings.SynchronizationSettings.{HistoryReplierSettings, MicroblockSynchronizerSettings, UtxSynchronizerSettings}
...
class SynchronizationSettingsSpecification extends FlatSpec with Matchers {
  "SynchronizationSettings" should "read values" in {
    ...
    val settings = config.as[SynchronizationSettings]("plix.synchronization")
