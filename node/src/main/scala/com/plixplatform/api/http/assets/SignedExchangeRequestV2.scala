...
import com.plixlatform.transaction.assets.exchange.{ExchangeTransaction, ExchangeTransactionV2, Order}
...
object SignedExchangeRequestV2 {
  implicit val orderFormat: Format[Order] = com.plixlatform.transaction.assets.exchange.OrderJson.orderFormat
