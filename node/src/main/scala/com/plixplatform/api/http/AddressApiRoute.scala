...
import com.plixplatform.common.utils.{Base58, Base64}
...
import com.plixplatform.state.{Blockchain, DataEntry}
  ...
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.plixplatform.api.http.SignedMessage",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.plixplatform.api.http.DataRequest",
        defaultValue =
