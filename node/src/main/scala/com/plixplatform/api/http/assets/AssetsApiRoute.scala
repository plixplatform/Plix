...
import com.plixlatform.api.common.{CommonAccountApi, CommonAssetsApi}
import com.plixlatform.api.http.ApiError._
import com.plixlatform.api.http._
import com.plixlatform.api.http.assets.AssetsApiRoute.DistributionParams
...
import com.plixlatform.transaction.assets.exchange.OrderJson._
import com.plixlatform.transaction.smart.script.ScriptCompiler
import com.plixlatform.transaction.{AssetIdStringLength, TransactionFactory}
import com.plixlatform.utils.{Time, _}
      ...
      val distributionTask = assetEi match {
        ...
        case Right(asset) =>
          Task
            ...
            .map(dst => Json.toJson(dst)(com.plixlatform.state.dstWrites): ToResponseMarshallable)
      }
