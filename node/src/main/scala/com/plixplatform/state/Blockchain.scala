...
import com.plixlatform.state.extensions.{AddressTransactions, BlockchainExtensions, Distributions}
...
trait Blockchain {
  ...
  def plixAmount(height: Int): BigInt
  ...
  def balance(address: Address, mayBeAssetId: Asset = Plix): Long
