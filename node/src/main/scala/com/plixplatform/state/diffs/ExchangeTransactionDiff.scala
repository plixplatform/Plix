...
import com.plixlatform.transaction.TxValidationError.{GenericError, OrderValidationError}
import com.plixlatform.transaction.assets.exchange.{ExchangeTransaction, Order, OrderV3}
