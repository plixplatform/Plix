...
import com.plixplatform.consensus.GeneratingBalanceProvider
...
import com.plixplatform.transaction.TxValidationError.{AliasDoesNotExist, GenericError}
...
package object state {
  ...
  implicit class BlockchainExt(private val blockchain: Blockchain) extends AnyVal {
    ...
    def plixPortfolio(address: Address): Portfolio = Portfolio(
