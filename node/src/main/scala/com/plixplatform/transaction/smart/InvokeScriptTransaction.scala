...
import com.plixplatform.lang.v1.compiler.Terms.{ARR, CaseObj, EVALUATED, FUNCTION_CALL}
import com.plixplatform.lang.v1.evaluator.ContractEvaluator
import com.plixplatform.lang.v1.{ContractLimits, FunctionHeader, Serde}
...
object InvokeScriptTransaction extends TransactionParserFor[InvokeScriptTransaction] with TransactionParser.MultipleVersions {
  ...
  def functionCallToJson(fc: Terms.FUNCTION_CALL): JsObject = {
    Json.obj(
      "function" -> JsString(fc.function.asInstanceOf[com.plixplatform.lang.v1.FunctionHeader.User].name),
      "args" -> JsArray(
        fc.args.map {
