...
import com.plixplatform.account.{Address, AddressOrAlias, Alias}
import com.plixplatform.common.state.ByteStr
import com.plixplatform.lang.v1.compiler.Terms.EVALUATED
import com.plixplatform.lang.v1.traits.domain.Tx.{Header, Proven}
import com.plixplatform.lang.v1.traits.domain._
...
import com.plixplatform.transaction.assets.exchange.{AssetPair, ExchangeTransaction, Order}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.plixplatform.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
