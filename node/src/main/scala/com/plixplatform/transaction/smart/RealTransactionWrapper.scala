...
import com.plixlatform.account.{Address, AddressOrAlias, Alias}
import com.plixlatform.common.state.ByteStr
import com.plixlatform.lang.v1.compiler.Terms.EVALUATED
import com.plixlatform.lang.v1.traits.domain.Tx.{Header, Proven}
import com.plixlatform.lang.v1.traits.domain._
import com.plixlatform.state._
import com.plixlatform.transaction._
import com.plixlatform.transaction.assets._
import com.plixlatform.transaction.assets.exchange.OrderType.{BUY, SELL}
import com.plixlatform.transaction.assets.exchange.{AssetPair, ExchangeTransaction, Order}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.plixlatform.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
