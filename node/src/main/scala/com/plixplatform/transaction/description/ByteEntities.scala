package com.plixlatform.transaction.description

import cats.{Functor, Semigroupal}
import com.google.common.primitives.{Ints, Longs, Shorts}
import com.plixlatform.account.{Address, AddressOrAlias, Alias, PublicKey}
import com.plixlatform.common.state.ByteStr
import com.plixlatform.common.utils.EitherExt2
import com.plixlatform.crypto.{KeyLength, SignatureLength}
...
import com.plixlatform.lang.v1.{ContractLimits, Serde}
import com.plixlatform.serialization.Deser
import com.plixlatform.state.DataEntry
import com.plixlatform.transaction.Asset.{IssuedAsset, Plix}
import com.plixlatform.transaction.TxValidationError.Validation
...
case class PaymentBytes(index: Int, name: String) extends ByteEntity[Payment] {
  ...
  def deserialize(buf: Array[Byte], offset: Int): Try[(Payment, Int)] = {
    Try {
      ...
      val asset             = maybeAssetId.fold[Asset](Plix)(IssuedAsset)
