package com.plixlatform.transaction.assets
...
import com.plixlatform.transaction.{Asset, ProvenTransaction, VersionedTransaction}
...
trait IssueTransaction extends ProvenTransaction with VersionedTransaction {
  ...
  override final val assetFee: (Asset, Long) = (Plix, fee)
