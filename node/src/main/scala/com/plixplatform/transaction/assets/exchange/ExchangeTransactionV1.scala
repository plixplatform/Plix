...
import com.plixplatform.account.{PrivateKey, PublicKey}
...
import com.plixplatform.transaction.assets.exchange.ExchangeTransaction._
...
case class ExchangeTransactionV1(buyOrder: OrderV1,
  ...
  override val builder: ExchangeTransactionV1.type = ExchangeTransactionV1
