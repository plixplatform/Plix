package com.plixplatform.features

case class BlockchainFeature private (id: Short, description: String)

object BlockchainFeatures {

  val SmallerMinimalGeneratingBalance = BlockchainFeature(1, "Minimum Generating Balance of 1000 PLIX")
  ...
  val MinimumGeneratingBalanceOf100   = BlockchainFeature(14, "Minimum Generating Balance of 100 PLIX")
