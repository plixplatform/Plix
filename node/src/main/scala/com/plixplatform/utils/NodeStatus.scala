...
import com.plixlatform.network.NS
    ...
    scheduler.scheduleAtFixedRate(0.seconds, 120.seconds) {
      ...
      def syncStatus: String = {
        ...
        val heightRemote = Try {
          val json = Json.parse(get("https://nodes.plixlatform.com/blocks/height"))
      ...
      val remoteVersion = Try {
        val json = Json.parse(get("https://nodes.plixlatform.com/node/version"))
