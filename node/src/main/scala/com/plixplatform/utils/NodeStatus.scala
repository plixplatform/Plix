...
import com.plixplatform.network.NS
    ...
    scheduler.scheduleAtFixedRate(0.seconds, 120.seconds) {
      ...
      def syncStatus: String = {
        ...
        val heightRemote = Try {
          val json = Json.parse(get("https://nodes.plixcoin.io/blocks/height"))
      ...
      val remoteVersion = Try {
        val json = Json.parse(get("https://nodes.plixcoin.io/node/version"))
