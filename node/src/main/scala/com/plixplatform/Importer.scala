...
import com.plixplatform.Exporter.Formats
...
import com.plixplatform.protobuf.block.PBBlocks
...
object Importer extends ScorexLogging {
  ...
  private[this] final case class ImportOptions(configFile: File = new File("plix-testnet.conf"),
  ...
  private[this] lazy val commandParser = {
    ...
    OParser.sequence(
      programName("plix import"),
      head("Plix Blockchain Importer", Version.VersionString),
      opt[File]('c', "config")
