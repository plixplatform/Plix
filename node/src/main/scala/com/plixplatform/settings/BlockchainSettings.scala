...
object FunctionalitySettings {
  val MAINNET: FunctionalitySettings = apply(
    ...
    preActivatedFeatures = Map(
      ...
      BlockchainFeatures.SmartAssets.id                     -> 456180,
      BlockchainFeatures.SmartAccountTrading.id             -> 456180,
      BlockchainFeatures.Ride4DApps.id                      -> 456180,
  ...
  val configPath = "plix.blockchain.custom.functionality"
}
...
object GenesisSettings {
  val MAINNET: GenesisSettings = GenesisSettings(
    1547912728383L,
    1547912728383L,
    Constants.UnitsInWave * Constants.TotalPlix,
    ByteStr.decodeBase58("4h2W2UqpguiH4NZBBbJoJmD28UZp9aun65prZHU8gcyeQAaPpZUn8aH2mgLK4EoSoK1tMHE1atBHqZiz4XtLm2Lm").toOption,
    List(
      GenesisTransactionSettings("3EJNm7sBs4Xif1RYNbgN4ehXmXmH49x95X3", Constants.UnitsInWave * Constants.TotalPlix),
    ),
    153722867L,
    60.seconds
  )
  ...
  val TESTNET: GenesisSettings = GenesisSettings(
    ...
    List(
      GenesisTransactionSettings("3JRnNWu4ubdf9PtZdSzUo4Emp4CwMRn68dF", (Constants.UnitsInWave * Constants.TotalPlix * 0.5).toLong),
      GenesisTransactionSettings("3JCwZJGvPsdw4QCoLyN7qangAmJT7N2BTkE", (Constants.UnitsInWave * Constants.TotalPlix * 0.5).toLong),
    ),
    153722867L,
    60.seconds
  )
...
object BlockchainSettings {
  ...
  def fromRootConfig(config: Config): BlockchainSettings = config.as[BlockchainSettings]("plix.blockchain")
