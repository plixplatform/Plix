...
import com.plixlatform.network.Handshake.InvalidHandshakeException
...
object HandshakeHandler extends ScorexLogging {
  ...
  def checkApplicationName(local: String, remote: String): Boolean = {
    ...
    (appName == "waves" || appName == "plix") && (chainId == "A" || chainId == "K" || chainId == "D" || chainId == "I") && chainId == localChainId
  }
