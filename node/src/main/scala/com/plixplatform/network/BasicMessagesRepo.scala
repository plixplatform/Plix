...
import com.plixplatform.mining.Miner.MaxTransactionsPerMicroblock
import com.plixplatform.network.message.Message._
import com.plixplatform.network.message._
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://plixplatform.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
