...
import com.plixlatform.mining.Miner.MaxTransactionsPerMicroblock
import com.plixlatform.network.message.Message._
import com.plixlatform.network.message._
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://plixlatform.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
