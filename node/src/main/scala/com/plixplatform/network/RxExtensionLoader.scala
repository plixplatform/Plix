...
import com.plixplatform.network.RxExtensionLoader.ApplierState.Buffer
import com.plixplatform.network.RxExtensionLoader.LoaderState.WithPeer
import com.plixplatform.network.RxScoreObserver.{ChannelClosedAndSyncWith, SyncWith}
            ...
            case LoaderState.Idle =>
              ...
              maybeKnownSigs match {
                case Some((knownSigs, optimistic)) =>
                  ...
                  val blacklisting = scheduleBlacklist(ch, s"Timeout loading extension").runToFuture
          ...
          firstInvalid match {
            ...
            case None =>
              if (unknown.isEmpty) {
                ...
                val blacklistingAsync = scheduleBlacklist(ch, "Timeout loading first requested block").runToFuture
