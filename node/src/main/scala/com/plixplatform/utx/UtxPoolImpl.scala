...
import com.plixlatform.settings.UtxSettings
import com.plixlatform.state.diffs.TransactionDiffer
import com.plixlatform.state.reader.CompositeBlockchain
import com.plixlatform.state.{Blockchain, Diff, Portfolio}
import com.plixlatform.transaction.Asset.IssuedAsset
import com.plixlatform.transaction.TxValidationError.{GenericError, SenderIsBlacklisted}
import com.plixlatform.transaction._
import com.plixlatform.transaction.assets.ReissueTransaction
...
class UtxPoolImpl(time: Time,
  ...
  import com.plixlatform.utx.UtxPoolImpl._
