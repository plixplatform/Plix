...
import com.plixplatform.settings.UtxSettings
...
import com.plixplatform.transaction.TxValidationError.{GenericError, SenderIsBlacklisted}
import com.plixplatform.transaction._
import com.plixplatform.transaction.assets.ReissueTransaction
...
class UtxPoolImpl(time: Time,
  ...
  import com.plixplatform.utx.UtxPoolImpl._
