...
import com.plixlatform.api.http.ApiError.InvalidAddress
...
import com.plixlatform.mining.{Miner, MinerDebugInfo}
import com.plixlatform.network.{LocalScoreChanged, PeerDatabase, PeerInfo, _}
import com.plixlatform.settings.{PlixSettings, RestAPISettings}
import com.plixlatform.state.diffs.TransactionDiffer
import com.plixlatform.state.extensions.Distributions
import com.plixlatform.state.{Blockchain, LeaseBalance, NG, TransactionId}
import com.plixlatform.transaction.TxValidationError.InvalidRequestSignature
import com.plixlatform.transaction._
import com.plixlatform.transaction.smart.script.trace.TracedResult
import com.plixlatform.transaction.smart.{InvokeScriptTransaction, Verifier}
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.plixlatform.http.DebugMessage",
        defaultValue = "{\n\t\"message\": \"foo\"\n}"
      )
    ))
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.plixlatform.http.RollbackParams",
