...
import com.plixlatform.transaction.TxValidationError.InvalidAddress
import com.plixlatform.utils.{ScorexLogging, base58Length}
...
object Address extends ScorexLogging {
  ...
  private[plixlatform] def createUnsafe(address: ByteStr): Address = {
