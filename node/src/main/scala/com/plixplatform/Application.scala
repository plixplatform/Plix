...
import com.plixlatform.actor.RootActorSystem
import com.plixlatform.api.http._
import com.plixlatform.api.http.alias.{AliasApiRoute, AliasBroadcastApiRoute}
import com.plixlatform.api.http.assets.{AssetsApiRoute, AssetsBroadcastApiRoute}
import com.plixlatform.api.http.leasing.{LeaseApiRoute, LeaseBroadcastApiRoute}
import com.plixlatform.consensus.PoSSelector
import com.plixlatform.consensus.nxt.api.http.NxtConsensusApiRoute
import com.plixlatform.db.openDB
import com.plixlatform.extensions.{Context, Extension}
import com.plixlatform.features.api.ActivationApiRoute
import com.plixlatform.history.StorageFactory
import com.plixlatform.http.{PlixApiRoute, DebugApiRoute, NodeApiRoute, SSLConnection}
import com.plixlatform.metrics.Metrics
import com.plixlatform.mining.{Miner, MinerImpl}
import com.plixlatform.network.RxExtensionLoader.RxExtensionLoaderShutdownHook
import com.plixlatform.network._
import com.plixlatform.settings.PlixSettings
import com.plixlatform.state.Blockchain
import com.plixlatform.state.appender.{BlockAppender, ExtensionAppender, MicroblockAppender}
import com.plixlatform.transaction.{Asset, Transaction}
import com.plixlatform.utils.{LoggerFacade, NTP, NodeStatus, ScorexLogging, SystemInformationReporter, Time, UtilApp}
import com.plixlatform.utx.{UtxPool, UtxPoolImpl}
...
object Application {
  private[plixlatform] def loadApplicationConfig(external: Option[File] = None): PlixSettings = {
  ...
  private[this] def startNode(configFile: Option[String]): Unit = {
    ...
    RootActorSystem.start("plixlatform", settings.config) { actorSystem =>
