...
import com.plixlatform.generator.GeneratorSettings.NodeAddress
import com.plixlatform.generator.Preconditions.{PGenSettings, UniverseHolder}
import com.plixlatform.generator.cli.ScoptImplicits
import com.plixlatform.generator.config.FicusImplicits
import com.plixlatform.generator.utils.Universe
import com.plixlatform.network.client.NetworkSender
import com.plixlatform.settings.PlixSettings
import com.plixlatform.transaction.Transaction
import com.plixlatform.utils.{LoggerFacade, NTP}
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  // IDEA bugs
  implicit val inetSocketAddressReader        = com.plixlatform.settings.inetSocketAddressReader
