...
import com.plixplatform.generator.GeneratorSettings.NodeAddress
import com.plixplatform.generator.Preconditions.{PGenSettings, UniverseHolder}
import com.plixplatform.generator.cli.ScoptImplicits
import com.plixplatform.generator.config.FicusImplicits
import com.plixplatform.generator.utils.Universe
import com.plixplatform.network.client.NetworkSender
import com.plixplatform.settings.PlixSettings
import com.plixplatform.transaction.Transaction
import com.plixplatform.utils.{LoggerFacade, NTP}
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  // IDEA bugs
  implicit val inetSocketAddressReader        = com.plixplatform.settings.inetSocketAddressReader
  ...
  val parser = new OptionParser[GeneratorSettings]("generator") {
    head("TransactionsGenerator - Plix load testing transactions generator")
  ...
  val plixSettings = PlixSettings.fromRootConfig(ConfigFactory.load())
  ...
  parser.parse(args, defaultConfig) match {
    ...
    case Some(finalConfig) =>
      ...
      val sender = new NetworkSender(plixSettings.networkSettings.trafficLogger, finalConfig.addressScheme, "generator", nonce = Random.nextLong())
