...
import cats.Show
import com.plixlatform.account.{AddressScheme, Alias, KeyPair}
import com.plixlatform.common.state.ByteStr
import com.plixlatform.common.utils.{Base58, EitherExt2}
import com.plixlatform.generator.NarrowTransactionGenerator.{ScriptSettings, Settings}
import com.plixlatform.generator.utils.Universe
...
import com.plixlatform.state.DataEntry.{MaxValueSize, Type}
...
import com.plixlatform.transaction.lease.{LeaseCancelTransaction, LeaseCancelTransactionV2, LeaseTransactionV2}
...
import com.plixlatform.utils.LoggerFacade
    ...
    object preconditions {
      ...
      val tradeAssetIssue = IssueTransactionV2
        .selfSigned(
          ...
          "Plix DEX is the best exchange ever".getBytes("UTF-8"),
          100000000,
          2,
          reissuable = false,
          fee = 100400000L,
      ...
      case ((allTxsWithValid, validIssueTxs, reissuableIssueTxs, activeLeaseTransactions, aliases), i) =>
        ...
        val tx = typeGen.getRandom match {
          ...
          case ExchangeTransactionV1 =>
            ...
            val pair      = AssetPair(Plix, IssuedAsset(preconditions.tradeAssetIssue.id()))
          ...
          case InvokeScriptTransaction =>
            ...
            val asset = randomFrom(Universe.IssuedAssets.filter(a => script.paymentAssets.contains(new String(a.name))))
              .fold(Plix: Asset)(tx => IssuedAsset(tx.id()))
