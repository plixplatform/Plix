package com.plixlatform.it.api
...
import com.plixlatform.api.http.assets.{ReissueV1Request, SignedIssueV1Request, SignedIssueV2Request, SignedTransferV2Request, TransferV1Request}
import com.plixlatform.api.http.{AddressApiRoute, ConnectReq}
import com.plixlatform.common.utils.EitherExt2
import com.plixlatform.features.api.ActivationStatus
import com.plixlatform.http.DebugMessage._
import com.plixlatform.http.{DebugMessage, RollbackParams, api_key}
import com.plixlatform.it.Node
import com.plixlatform.it.util.GlobalTimer.{instance => timer}
import com.plixlatform.it.util._
import com.plixlatform.lang.v1.FunctionHeader
import com.plixlatform.lang.v1.compiler.Terms
import com.plixlatform.lang.v1.compiler.Terms.FUNCTION_CALL
import com.plixlatform.state.{AssetDistribution, AssetDistributionPage, DataEntry, Portfolio}
import com.plixlatform.transaction.assets.{BurnTransaction, IssueTransaction, SetAssetScriptTransaction, SponsorFeeTransaction}
...
import com.plixlatform.transaction.{CreateAliasTransaction, DataTransaction}
...
object AsyncHttpApi extends Assertions {
  ...
  implicit class NodeAsyncHttpApi(val n: Node) extends Assertions with Matchers {
    ...
    def payment(sourceAddress: String, recipient: String, amount: Long, fee: Long): Future[Transaction] =
      postJson("/plix/payment", PaymentRequest(amount, fee, sourceAddress, recipient)).as[Transaction]
    ...
    def debugStateAt(height: Long): Future[Map[String, Long]] = getWithApiKey(s"/debug/statePlix/$height").as[Map[String, Long]]
