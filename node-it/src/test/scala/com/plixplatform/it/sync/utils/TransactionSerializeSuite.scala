package com.plixplatform.it.sync.utils

import com.plixplatform.account.{Address, AddressScheme, Alias, PublicKey}
...
import com.plixplatform.state.{BinaryDataEntry, BooleanDataEntry, IntegerDataEntry}
...
import com.plixplatform.transaction.lease.{LeaseCancelTransactionV1, LeaseCancelTransactionV2, LeaseTransactionV1, LeaseTransactionV2}
...
import com.plixplatform.transaction.transfer.{MassTransferTransaction, TransferTransactionV1, TransferTransactionV2}
import com.plixplatform.transaction.{CreateAliasTransactionV1, CreateAliasTransactionV2, DataTransaction, Proofs}
...
class TransactionSerializeSuite extends BaseTransactionSuite with TableDrivenPropertyChecks {
  ...
  private val buyV2 = OrderV2(
    ...
    AssetPair.createAssetPair("PLIX", "9ZDWzK53XT5bixkmMwTJi2YzgxCqn5dUajXFcT2HcFDy").get,
    OrderType.BUY,
    2,
    60.plix,
    tsOrderFrom,
  ...
  private val transfers = MassTransferTransaction
    .parseTransfersList(List(Transfer(firstAddress, 1.plix), Transfer(secondAddress, 2.plix)))
    .right
    .get
