...
import com.plixlatform.consensus.FairPoSCalculator
...
import com.plixlatform.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.plixlatform.it.api.SyncHttpApi._
import com.plixlatform.it.transactions.NodesFromDocker
import com.plixlatform.it.{NodeConfigs, WaitForHeight2}
import com.plixlatform.network.RawBytes
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("plix.miner.enable = yes"))
      .buildNonConflicting()
