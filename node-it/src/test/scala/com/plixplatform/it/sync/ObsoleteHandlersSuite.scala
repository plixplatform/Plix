package com.plixlatform.it.sync

import com.plixlatform.api.http.alias.CreateAliasV1Request
import com.plixlatform.api.http.assets.{
  BurnV1Request,
  IssueV1Request,
  MassTransferRequest,
  ReissueV1Request,
...
import com.plixlatform.api.http.leasing.{LeaseCancelV1Request, LeaseV1Request, SignedLeaseCancelV1Request, SignedLeaseV1Request}
import com.plixlatform.it.api.SyncHttpApi._
import com.plixlatform.it.api.Transaction
...
import com.plixlatform.api.http.DataRequest
...
class ObsoleteHandlersSuite extends BaseTransactionSuite {
  ...
  test("assets masstransfer") {
    ...
    val transfers                               = List(Transfer(secondAddress, 1.plix), Transfer(thirdAddress, 2.plix))
