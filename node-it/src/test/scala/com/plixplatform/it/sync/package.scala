...
import com.plixlatform.transaction.assets.{IssueTransactionV1, IssueTransactionV2}
import com.plixlatform.transaction.smart.script.ScriptCompiler

package object sync {
  val smartFee: Long                   = 0.004.plix
  val minFee: Long                     = 0.001.plix
  val leasingFee: Long                 = 0.002.plix
  val issueFee: Long                   = 1.plix
  val burnFee: Long                    = 1.plix
  val sponsorFee: Long                 = 1.plix
  val setAssetScriptFee: Long          = 1.plix
  val setScriptFee: Long               = 0.01.plix
  val transferAmount: Long             = 10.plix
  val leasingAmount: Long              = transferAmount
  val issueAmount: Long                = transferAmount
  val massTransferFeePerTransfer: Long = 0.0005.plix
  val someAssetAmount: Long            = 9999999999999L
  val matcherFee: Long                 = 0.003.plix
  val orderFee: Long                   = matcherFee
  val smartMatcherFee: Long            = 0.007.plix
